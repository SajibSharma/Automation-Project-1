...
describe('This is first test suite, Sajib Sharma', () => {
    it('User can submit data only when valid mandatory values are added', () => {
        //Today's Date:5th July
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('input[name="firstName"]').type('Sajib')
        cy.get('input[name="lastName"]').type('Sharma') 
        cy.get('input[name="password"]').type('Cerebrumhub123')
        cy.get('[name="confirm"]').type('Cerebrumhub123')
